...
public class Menu extends AppCompatActivity {
    ...
    private SharedPrefPrefences sharedPrefPrefences;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_makanan_layout);
        handler.postDelayed(runnable, 1000);
        dbHelper = new DBHelper(this);
        sharedPrefPrefences = new SharedPrefPrefences(this);
        ...
        penjelasan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Menu.this, PenjelasanActivity.class));
            }
        });
    ...
    public String cp() {
        return "Copyright (c) 2018-2019\nmade By Mobile Programming 8";
    }
