...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE db_pesanan(id integer primary key autoincrement, no_meja int not null,no_urut text not null , nama text not null, tanggal datetime not null,harga integer not null, pesanan text not null ,menu_1 int not null,menu_2 int not null,menu_3 int not null,menu_4 int not null,menu_5 int not null,menu_6 int not null,menu_7 int not null,menu_8 int not null);";
